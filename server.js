...
app.post('/api/hf-chat', async (req, res) => {
  try {
    ...
    const models = [String(model || ''), 'deepseek-ai/DeepSeek-V4-Flash', 'deepseek-ai/DeepSeek-V4-Pro', 'meta-llama/Llama-3.3-70B-Instruct', 'openai/gpt-oss-20b', 'zai-org/GLM-5.2', 'tencent/Hy3', 'moonshotai/Kimi-K3', 'Qwen/Qwen2.5-72B-Instruct', 'Qwen/Qwen3.6-27B'].filter(Boolean);
